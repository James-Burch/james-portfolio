...
//   return (
//     <section
//       className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50/50"
//       ref={ref}
//     >
...
//             I&apos;m passionate about creating innovative solutions and bringing
...
//               After 13+ months of intensive learning, I&apos;ve built 8
//               comprehensive projects that showcase my skills in full-stack
//               development. I specialize in creating modern, responsive web
//               applications using the latest technologies.
//             </p>
//             <p className="text-gray-600 leading-relaxed">
//               My background in data analysis gives me a unique perspective on
//               building user-centric applications that don&apos;t just look good,
//               but also provide meaningful insights and exceptional user
//               experiences.
//             </p>
//             <p className="text-gray-600 leading-relaxed">
//               I&apos;m ready to bring this passion and dedication to your team,
//               contributing to innovative projects and continuing to grow as a
//               developer.
//             </p>
//           </div>
...
//                 <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
//                 <span className="text-gray-600">
//                   Passion for continuous learning and staying current with
//                   technology
//                 </span>
//               </li>
//               <li className="flex items-start gap-3">
